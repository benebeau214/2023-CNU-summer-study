<?php
	...
	if ($upfile_name && !$upfile_error)
	{
		...
		$uploaded_file = $upload_dir.$copied_file_name; //사용자들의 파일이름 중복을 피하기 위해 날짜를 덧붙임
		...
		if (!move_uploaded_file($upfile_tmp_name, $uploaded_file) )//$upfile_tmp_name을 $uploaded_file이 지정한 경로로 이동
		{
				echo("
					<script>
